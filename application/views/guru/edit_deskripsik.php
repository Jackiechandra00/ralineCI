            ...
            <div class="card">
              ...
              <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-8 pr-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Deskripsi" name="deskripsi_k4" required >
                ...
                <div class="card-footer">
                  <input class="btn btn-primary" type="submit" name="editDeskripsik" value="Simpan">
                </div>
              </form>
              </div>
            </div>
