          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h5 class="title">Daftar Guru</h5>
                <a href="<?php echo base_url("Adminis/tambah_guru");?>"><button class="btn btn-primary" type="submit">Tambah Guru</button>
                    ...
                    <tbody>
                      <?php foreach($gurus as $guru): ?>
                        <tr>
                          ...
                          <td>
                            <?= strtoupper($guru->mapel) ?>  
                          </td>
                          <td class="text-center">
                            <a class="btn" style="color: white;" href="<?= base_url("Adminis/edit_guru?nip=$guru->nip") ?>">Edit</a>&nbsp;&nbsp;
                            <a class="btn" style="color: white;" href="<?= base_url("Adminis/hapus_guru?nip=$guru->nip") ?>">Hapus</a>
                          </td>
                        </tr>
                      <?php endforeach; ?>
