...
class AdminModel extends CI_Model
{
  ...
  public function get_nilai_spesifik($nis){
    ...
    return $this->db->where("nis", $nis)->get("detail_ekstra")->result_array();
  }

  public function get_extra_spesifik($nis){
   // return $this->db->select("n.*")->where("n.nis", $nis)->get("nilai n")->result();
    return $this->db->where("nis", $nis)->get("detail_ekskul")->result_array();
  }
